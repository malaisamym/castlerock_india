...
var jQueryProductcontainer = jQuery('.products_container');

jQueryProductcontainer .isotope({
itemSelector : '.element'
});


var jQueryoptionSets = jQuery('#options_products .option-set'),
jQueryoptionLinks = jQueryoptionSets.find('a');
...
jQueryProductcontainer .isotope( options );
}
...
jQuery(document).ready(function() {
	...
	$("header").delegate("nav input[type='image']", "click", function(){
		$("header #searchBox").toggle('slow');
		return false;
	});
	
	$("#menuResponsive img").live("click", function(){
